...
func main() {
	...
	reqMsg, err := messages.AuthorizeRequest(idTagRaw)
	if err != nil {
	...
	domainReq, err := messages.AuthorizeRequest(payload.IdTag)
	if err != nil {
	...
	confMsg, err := messages.AuthorizeConfirmation(confInfo)
	if err != nil {
	...
	parsedConf := messages.AuthorizeConfirmationMessage{
