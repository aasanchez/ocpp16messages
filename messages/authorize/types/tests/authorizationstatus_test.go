...
func TestAuthorizationStatus_validAccepted(t *testing.T) {
	...
	status, err := at.SetAuthorizationStatus(at.Accepted)
	if err != nil {
...
func TestAuthorizationStatus_validBlocked(t *testing.T) {
	...
	status, err := at.SetAuthorizationStatus(at.Blocked)
	if err != nil {
...
func TestAuthorizationStatus_validExpired(t *testing.T) {
	...
	status, err := at.SetAuthorizationStatus(at.Expired)
	if err != nil {
...
func TestAuthorizationStatus_validInvalid(t *testing.T) {
	...
	status, err := at.SetAuthorizationStatus(at.Invalid)
	if err != nil {
...
func TestAuthorizationStatus_validConcurrentTx(t *testing.T) {
	...
	status, err := at.SetAuthorizationStatus(at.ConcurrentTx)
	if err != nil {
