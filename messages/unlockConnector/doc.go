// UnlockConnector handling rules:
//
...
//
// Notes:
//   - UnlockConnector.req only affects the cable retention lock on the connector.
//     It does not unlock a connector access door or other enclosure.
