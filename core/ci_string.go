...
// Validate returns an error if the string exceeds 20 characters.
...
// Validate returns an error if the string exceeds 25 characters.
...
// Validate returns an error if the string exceeds 50 characters.
